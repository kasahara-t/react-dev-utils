...
export const ListBox: FC<ListBoxProps> = ({ items, label, defaultValue, onChange }) => {
              ...
              >
                <span
                  className={classNames(
                    ...
                    item.value === selectedItem.value ? 'tw-font-bold' : 'tw-font-normal',
                  )}
                >
                  {item.label}
                </span>
